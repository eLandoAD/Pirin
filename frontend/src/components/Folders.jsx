...
import { Folder, ChevronRight, Trash2, Pencil } from "lucide-react";
import { useFolders } from "../hooks/useFolders";

// showModal e onCloseModal arrivano da App.jsx
function Folders({ showModal, onCloseModal }) {
  ...
  function handleCreateFolder() {
    ...
    setNewFolderName("");
    onCloseModal(); // avvisa App.jsx di chiudere il modal
  }

  function handleClose() {
    setNewFolderName(""); // resetta il campo ogni volta che chiudi
    onCloseModal();
  }
  ...
  return (
    <div className="rounded-lg border-2 border-slate-300 bg-white p-4 w-full">
      ...
      {/* Modal — controllato da App.jsx tramite showModal */}
      {showModal && (
        <div
